"""
InsurEdge: Property & Casualty (P&C) Actuarial Reserving & Claims Analytics - Synthetic Telemetry Data Generator
"""
import argparse
import datetime
import os
...
def generate_dataset(n_records=10000, output_dir="data"):
    ...
    print(f"Generating {n_records} records for InsurEdge-Property-Casualty-Actuarial-Analytics...")
    records = []
